...
if not botConfigured:
    ...
    async def on_ready():
        ...
        async def infrequent():
            ...
            channel = thisGuild.get_channel(announcementsChannelID)
            name = thisGuild.owner.display_name
            pfp = thisGuild.owner.display_avatar
            embed = discord.Embed(title="Inactive User Removal Started", description="This could take a couple hours", color=discord.Color.red())
            embed.set_author(name=f"{name}", url="https://discord.com/channels/1045433182822072390/1045434186825203713", icon_url=pfp.url)
            embed.add_field(name="The bot will not respond to commands during this time", value="")
            ...
            embed2 = discord.Embed(title="Inactive User Removal Finished", color=discord.Color.green())
            embed2.set_author(name=f"{name}", url="https://discord.com/channels/1045433182822072390/1045434186825203713", icon_url=pfp.url)
            embed2.add_field(name="The bot should now respond to commands", value="")
